...
if (usingFallbackCredentials) {
  ...
  console.warn(
    '[supabase] Using fallback Supabase credentials for local/dev runtime. Configure VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY for production parity.'
  );
}
